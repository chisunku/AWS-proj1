 ...
 */
export declare type JwkToKeyObjectTransformerSync = (jwk: RsaSignatureJwk, alg?: SupportedSignatureAlgorithm, issuer?: string, kid?: string) => GenericKeyObject;
/**
...
export declare class KeyObjectCache {
     ...
     */
    transformJwkToKeyObjectSync(jwk: RsaSignatureJwk, issuer?: Issuer): GenericKeyObject;
    transformJwkToKeyObjectAsync(jwk: RsaSignatureJwk, issuer?: Issuer): Promise<GenericKeyObject>;
